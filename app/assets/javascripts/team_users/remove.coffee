  ...
  $('.remove_user_form').on 'submit', (e) ->
    $.ajax e.target.action,
      ...
      success: (data, text, jqXHR) ->
        ...
        Materialize.toast('User successfully removed from channel &nbsp;<b>:(</b>', 4000, 'green')
      error: (jqXHR, textStatus, errorThrown) ->
        Materialize.toast('An error occurred while removing user from channel &nbsp;<b>:(</b>', 4000, 'red')
